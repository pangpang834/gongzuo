...
wap.bootcamp.common.ui.List.prototype.canDecorate = function($element) {
  return (
      ...
      this.plugins_.every(function(plugin) { return plugin.canDecorateList($element); })
  );
};
...
wap.bootcamp.common.ui.List.prototype.decorateInternal = function($element) {
  ...
  this.plugins_
      .map(function(plugin) { return plugin.getCssClasses(); })
      .forEach(function(classes) { goog.dom.classlist.addAll($element, classes); });

  this.plugins_.forEach(function(plugin) { plugin.decorateList(this); }.bind(this));
  ...
  goog.array
      ...
      .forEach(function($child) {
        ...
        item.decorate($child);
        this.plugins_
            .filter(function(plugin) { return plugin.canDecorateItem(this, item); }.bind(this))
            .forEach(function(plugin) { plugin.decorateItem(this, item); }.bind(this));
...
wap.bootcamp.common.ui.List.prototype.disposeInternal = function() {
  this.forEachChild(function(listItem) {
    this.plugins_.forEach(function(plugin) { plugin.disposeItem(this, listItem); }.bind(this));
  }, this);
  this.plugins_.forEach(function(plugin) { plugin.disposeList(this);}.bind(this));
  this.elementItemMap_ = null;
...
wap.bootcamp.common.ui.List.prototype.removeItem = function(item) {
  this.plugins_.forEach(function(plugin) { plugin.disposeItem(this, item); }.bind(this));
